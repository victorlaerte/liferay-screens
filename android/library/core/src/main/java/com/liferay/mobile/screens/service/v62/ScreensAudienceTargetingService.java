...
public class ScreensAudienceTargetingService extends BaseService {
	...
	public JSONObject addScreensMobile(String appId, String placeholderId, long assetEntryId, String customContentText, JSONObjectWrapper serviceContext) throws Exception {
		...
		try {
			...
			_params.put("customContentText", checkNull(customContentText));
	...
	public JSONObject updateScreensMobile(long screensMobileId, long tacticId) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateScreensMobile(long screensMobileId, String appId, String placeholderId, long assetEntryId, String customContentText, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
